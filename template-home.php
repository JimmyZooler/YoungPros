    ...
    <section id="home-page-intro" style="background-image:url('<?php echo get_template_directory_uri(); ?>/dist/images/hero_banner.png')">
        <div class='webinar-helper'>    
            <div class="webinar text-center">
                ...
                <h2>Launch your <span>2017</span><br><span id="game-plan">game plan</span></h2>
                <p>Step by Step Webinar into having<br>your Best Year Ever!</p>
                <div class="form-inner">
                    ...
                    <div class="mc-field-group">
                        ...
                        <input type="submit" value="I Can't Wait!" name="subscribe" id="mc-embedded-subscribe" class="button">
                        </div>
                    </form>
                    </div>
