...
<?php get_header(); ?>
    ...
    <section id="home-page-intro" style="background-image:url('<?php echo get_template_directory_uri(); ?>/dist/images/hero.png')">
<!--        <div class="row text-center">
    ...
    <section class="subscription-bar" style="background-image: url('<?php echo get_template_directory_uri(); ?>/dist/images/subscription-background.jpg');">
        <div class="row">
            ...
            <a href="#subscribe-popup" class="open-subscribe-popup"><button class="subscription-button"><?php the_field('subscription_button_text'); ?></button></a>
        </div>
